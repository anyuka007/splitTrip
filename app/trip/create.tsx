    ...
    >
      ...
      <View className="flex">
        ...
        {participants.length > 0 ? (
          ...
          <Text
            className={
              !addParticipantMode ? "text-gray-500 text-regular" : "hidden"
            }
          >
            No participants
          </Text>
          ...
          <Pressable
            ...
            className={
              addParticipantMode
                ...
                ? "bg-secondary opacity-50 w-1/2 h-12 flex flex-row items-center justify-center rounded-xl my-2 gap-2"
                : "bg-secondary w-1/2 h-12 flex flex-row items-center justify-center rounded-xl my-2 gap-2"
            }
          >
            <FontAwesome name="plus" size={16} color="white" />
            <Text className="text-regular text-white font-medium">
              Add Participant
            </Text>
          </Pressable>
        </View>
      ...
      <CustomButton
        ...
        onPress={submit}
        whileLoadingText="Creating Trip..."
      />
    </KeyboardAwareScrollView>
  );
};
