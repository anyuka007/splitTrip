...
const ExpenseDetails = () => {
  ...
  const participantsWhoShare = shares
    .map((share) => {
    ...
    <View className="px-4 h-full">
            ...
            <View className="mb-4">
              <View className="flex-row justify-between items-center">
                ...
                <CustomButton
                  text="Edit"
                  onPress={() =>
                    router.push(`/trip/${tripId}/expense/edit/${expenseId}`)
                  }
                  classname="w-[23%] h-12 bg-secondary rounded-xl my-2 flex items-center justify-center"
                />
              </View>
            </View>
      ...
      <View className="flex flex-row justify-end mt-4 absolute bottom-20 gap-2 w-full">
        ...
        <ConfirmModal
          ...
          confirmText={isSubmitting ? "" : "Yes"}
          cancelText={isSubmitting ? "" : "No"}
        />
      </View>
    </View>
  );
